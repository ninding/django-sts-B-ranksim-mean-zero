...
from djangoSts.mean_zero.allennlp_mods.numeric_field import NumericField

from djangoSts.mean_zero.tasks import STSBTask
...
def myprocess_task(data, vocab):
    ...
    token_indexer = {}
    token_indexer["words"] = SingleIdTokenIndexer()
    data = process_split(data, token_indexer)
