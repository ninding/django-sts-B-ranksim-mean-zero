...
from djangoSts.mean_zero.preprocess import build_tasks, myprocess_task
from djangoSts.mean_zero.models import build_model
from djangoSts.mean_zero.trainer import build_trainer
from djangoSts.mean_zero.evaluate import evaluate
from djangoSts.mean_zero.util import device_mapping, query_yes_no, resume_checkpoint
...
def main(s,mydata=None):
    ...
    if 'store_root' not in d:
        d['store_root'] = './djangoSts/mean_zero/checkpoint'
