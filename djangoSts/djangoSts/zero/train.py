...
from djangoSts.zero.preprocess import build_tasks, myprocess_task
from djangoSts.zero.models import build_model
from djangoSts.zero.trainer import build_trainer
from djangoSts.zero.evaluate import evaluate
from djangoSts.zero.util import device_mapping, query_yes_no, resume_checkpoint
...
def main(s,mydata=None):
    ...
    if 'store_root' not in d:
        d['store_root'] = './djangoSts/zero/checkpoint'
